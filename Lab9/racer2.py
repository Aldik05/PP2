...
path = os.path.join(os.path.dirname(__file__), 'images_for_racer')

# Загрузка изображений из папки images_for_racer
background_image = pygame.image.load(os.path.join(path, 'AnimatedStreet.png'))
enemy_image      = pygame.image.load(os.path.join(path, 'Enemy.png'))
player_image     = pygame.image.load(os.path.join(path, 'Player.png'))
coin_image_L1    = pygame.image.load(os.path.join(path, 'money1.png'))
coin_image_L2    = pygame.image.load(os.path.join(path, 'money2.png'))
coin_image_L3    = pygame.image.load(os.path.join(path, 'money3.png'))
